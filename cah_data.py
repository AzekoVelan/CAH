...
white_cards = [
    ...
    "A gossamer stream of jizz that catches the light as it arcs through the morning air. (Also in the Hidden Compartment Pack)",
    "A horde of Vikings.",
    ...
    "Getting cummed on.",
    "Getting drugs off the street and into my body. (Also in the Hidden Compartment Pack)",
    "Getting fingered.",
    "Girls.",
    ...
    "How far I can get my own penis up my butt. (Also in the Hidden Compartment Pack)",
    "Huffing spray paint.",
    "Huge biceps.",
    "Illegal immigrants.",
    "Itchy pussy.",
    ...
    "Ruth Bader Ginsburg brutally gaveling your penis. (Also in the Hidden Compartment Pack)",
